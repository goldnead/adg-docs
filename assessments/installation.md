...
`goldnead/statamic-assessments` is on Packagist and installs with the block below, but it is
not part of the Suite as sold today, so there is no licence to buy for a production site. See
[licensing](/guide/licensing) and [how far along each addon is](/guide/maturity).
:::
