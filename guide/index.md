...
This site documents twenty-nine packages for **Statamic 6**. They are separate
Composer packages, released and versioned independently, and each one is useful
on its own. Twenty-seven of them are Statamic addons; Identity Contracts and Flow
...
All twenty-nine are tagged and published on Packagist, so a bare
...
| Platform | [Activity](/activity/), [Notifications](/notifications/), [Entitlements](/entitlements/), [Booking](/booking/), [Client Rooms](/clientrooms/), [Courses](/courses/), [Private Media](/private-media/), [Flow Canvas](/flow-canvas/) | Shared services any domain addon can record into, ask, or build on. |
...
| Content | [Events](/events/), [Table of Contents](/toc/), [Inline Edit](/inline-edit/), [Consent](/consent/) | Dated content, editing on the live page, cookie consent, and front-end helpers for editorial work. |

A one-page tour of all twenty-nine, with the dependency graph, is in
