...
This site documents twenty-eight packages for **Statamic 6**. They are separate
Composer packages, released and versioned independently, and each one is useful
on its own. Twenty-six of them are Statamic addons; Identity Contracts and Flow
...
| Platform | [Activity](/activity/), [Notifications](/notifications/), [Entitlements](/entitlements/), [Booking](/booking/), [Client Rooms](/clientrooms/), [Courses](/courses/), [Flow Canvas](/flow-canvas/) | Shared services any domain addon can record into, ask, or build on. |
...
A one-page tour of all twenty-eight, with the dependency graph, is in
