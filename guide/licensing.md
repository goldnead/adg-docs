...
**All thirty-two packages are on Packagist**, commercial ones included, and
every one installs with a bare `composer require`.

Being on Packagist is not the same as being free. **Twenty-three are commercial** and
...
Client Rooms, Assessments, Certificates, Smart Links and Affiliates are commercial
as well, and on Packagist, but none of them is part of the Suite as sold today.
