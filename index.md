...
hero:
  ...
  tagline: >
    Twenty-nine packages for Statamic 6: a CRM, email marketing, a visual automation
    ...
    gated resources, private media, courses, assessments, client rooms, events and content tooling.
...
Twenty-nine packages, twenty-four of them public inside five weeks, and only some
...
Each addon installs on its own. All twenty-nine are on Packagist, so a bare
