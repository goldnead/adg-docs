---
title: Identity Contracts changelog
editLink: false
---

# Changelog

<AddonHeader slug="identity-contracts" />

Release notes for `goldnead/statamic-identity-contracts`, as published with the package.
